...
import torch
# TODO 这里训练和预测可能不太一样？
from pytorch_pretrained_bert import BertConfig  # 预测用
# from transformers import BertConfig  # 训练+preprocess用
import distributed
from models import data_loader
from models import model_builder_LAI as model_builder
